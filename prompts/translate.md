...
- For bilingual mode: interleave English and Chinese paragraph by paragraph.
  After each person's English summary, place the Chinese translation directly below
  (separated by a blank line), then move to the next person. Same for podcasts.
