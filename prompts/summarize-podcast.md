...
- Use `signal.score`, `signal.tags`, `signal.reasons`, and `signal.matchedInterests`
  to decide which parts of the transcript are strongest for TechPrazzi readers.
...
- Add one short "Why it matters" sentence.
