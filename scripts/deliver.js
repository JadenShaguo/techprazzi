...
//
// The script reads delivery config from ~/.techprazzi/config.json
// and API keys from ~/.techprazzi/.env
//
// Delivery methods:
...
async function sendEmail(text, apiKey, toEmail) {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'TechPrazzi <digest@resend.dev>',
      to: [toEmail],
      subject: `TechPrazzi Digest — ${new Date().toLocaleDateString('en-US', {
